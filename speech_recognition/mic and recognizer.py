...
# secrets = dotenv_values("C:\\Users\\alihi\\Desktop\\Programming\\CRUISE\\Code\\cruise-AI\\speech_recognition\\.env")

# API_KEY = secrets["SPEECHMATICS_API_KEY"]
# LANGUAGE = "ar"
...
#     print(f"[partial] {get_display(arabic_reshaper.reshape(msg["metadata"]["transcript"]))}")

# # Define an event handler to print the full transcript
# def print_transcript(msg):
#     print(f"[FINAL] {get_display(arabic_reshaper.reshape(msg["metadata"]["transcript"]))}")
...
# Command run: python -u "c:\Users\alihi\Desktop\Programming\CRUISE\Code\cruise-AI\speech_recognition\mic and recognizer.py" -a <API_KEY> -l ar